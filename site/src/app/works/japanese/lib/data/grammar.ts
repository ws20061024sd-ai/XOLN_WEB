...
export const grammarQuestions: GrammarQuestion[] = [
  ...
  { id:"g-380", question:"彼は日本語が上手な（　　　）英語も堪能だ。", options:["うえに","かわりに","とおりに","かぎり"], answer:0, explanation:"〜うえに表叠加（而且）。上手なうえに=不仅好而且。", knowledgePoint:"累加·うえに", jlptLevel:"N3" },
  { id:"g-381", question:"今日は日曜日な（　　　）会社に行く。", options:["のに","から","ので","けど"], answer:0, explanation:"のに表逆接（却）。日曜日なのに=明明是周日却。", knowledgePoint:"逆接·のに", jlptLevel:"N4" },
  { id:"g-382", question:"この店は安い（　　　）味もいい。", options:["うえに","かわりに","ついでに","とおり"], answer:0, explanation:"〜うえに表叠加优点。安いうえに=不仅便宜而且。", knowledgePoint:"累加·うえに", jlptLevel:"N3" },
  { id:"g-383", question:"彼は若い（　　　）しっかりしている。", options:["わりに","くせに","のに","から"], answer:0, explanation:"〜わりに表与预期相反（不含责备）。若いわりに=虽然年轻却。", knowledgePoint:"逆接·わりに", jlptLevel:"N3" },
  { id:"g-384", question:"徹夜した（　　　）テストの点数が悪かった。", options:["わりに","くせに","のに","から"], answer:0, explanation:"〜わりに表与努力不成正比。徹夜したわりに=熬夜了却。", knowledgePoint:"逆接·わりに", jlptLevel:"N3" },
  { id:"g-385", question:"値段が高い（　　　）栄養がある。", options:["わりに","かわりに","くせに","のに"], answer:1, explanation:"〜かわりに表交换条件。高いかわりに=虽然贵但（取而代之）有营养。", knowledgePoint:"交換·かわりに", jlptLevel:"N3" },
  { id:"g-386", question:"ここは一年（　　　）暖かい。", options:["を通じて","について","によって","に対して"], answer:0, explanation:"〜を通じて表整个期间。一年を通じて=一整年。", knowledgePoint:"範囲·を通じて", jlptLevel:"N3" },
  { id:"g-387", question:"大学を卒業した（　　　）就職していない。", options:["ものの","うえに","かわりに","とおりに"], answer:0, explanation:"〜ものの表虽然…但…。卒業したものの=虽然毕业了但。", knowledgePoint:"逆接·ものの", jlptLevel:"N3" },
  { id:"g-388", question:"使えば使う（　　　）便利さがわかる。", options:["ほど","だけ","まで","より"], answer:0, explanation:"〜ば〜ほど表越…越…。使えば使うほど=越用越。", knowledgePoint:"比較·ほど", jlptLevel:"N3" },
  { id:"g-389", question:"彼は天才と言う（　　　）成績がいい。", options:["ほど","だけあって","かわりに","わりに"], answer:1, explanation:"〜だけあって表不愧为。天才と言うだけあって=不愧被称为天才。", knowledgePoint:"評価·だけあって", jlptLevel:"N3" },
  { id:"g-390", question:"試験に合格（　　　）必死に勉強した。", options:["するには","すれば","しても","するのに"], answer:0, explanation:"〜するには表为了…需要。合格するには=为了合格。", knowledgePoint:"目的·には", jlptLevel:"N4" },
  { id:"g-391", question:"会議は5時（　　　）終わる予定だ。", options:["まで","までに","までで","までが"], answer:1, explanation:"〜までに表在…之前（截止点）。5時までに=在5点前。", knowledgePoint:"期限·までに", jlptLevel:"N4" },
  { id:"g-392", question:"こんなに混んでいる（　　　）祭日なのか。", options:["から","ので","のは","とは"], answer:3, explanation:"〜とは表发现/惊讶。混んでいるとは=竟然这么拥挤。", knowledgePoint:"発見·とは", jlptLevel:"N3" },
  { id:"g-393", question:"このキノコは食べられる（　　　）わからない。", options:["か","かどうか","のか","だろう"], answer:1, explanation:"〜かどうか表是否。食べられるかどうか=能不能吃。", knowledgePoint:"疑問·かどうか", jlptLevel:"N4" },
  { id:"g-394", question:"彼が犯人（　　　）疑われている。", options:["として","について","によって","にとって"], answer:0, explanation:"〜として表作为（身份）。犯人として=作为嫌疑人。", knowledgePoint:"資格·として", jlptLevel:"N3" },
  { id:"g-395", question:"親に（　　　）感謝している。", options:["ついて","よって","とって","対して"], answer:3, explanation:"〜に対して表对…（对象）。親に対して=对父母。", knowledgePoint:"対象·に対して", jlptLevel:"N4" },
  { id:"g-396", question:"彼は経験が浅い（　　　）仕事が早い。", options:["かぎり","わりに","くせに","ものの"], answer:1, explanation:"〜わりに表与预期相反。経験が浅いわりに=经验不足却做得快。", knowledgePoint:"逆接·わりに", jlptLevel:"N3" },
  { id:"g-397", question:"努力した（　　　）結果が出せなかった。", options:["ものの","うえに","かわりに","わりに"], answer:0, explanation:"〜ものの表虽然…但…。努力したものの=虽然努力了但。", knowledgePoint:"逆接·ものの", jlptLevel:"N3" },
  { id:"g-398", question:"私は学生（　　　）この意見に賛成だ。", options:["について","として","によって","にとって"], answer:1, explanation:"〜として表立场。学生として=作为学生。", knowledgePoint:"資格·として", jlptLevel:"N3" },
  { id:"g-399", question:"今日（　　　）三日間何も食べていない。", options:["まで","までに","までで","までが"], answer:2, explanation:"〜までで表到…为止的期间。今日までで=到今天为止。", knowledgePoint:"期限·までで", jlptLevel:"N4" },
];
